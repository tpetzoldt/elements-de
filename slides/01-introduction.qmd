...
4.  Ausgewählte Klassische Tests
5.  Lineare Modelle
6.  Varianzanalyse
7.  Nichtlineare Regression
8.  grundlagen der Zeitreihenanalyse (optional)
9.  Multivariate Statistik
...
-   Folien, Tutorien:
    [tpetzoldt.github.io/elements-de](https://tpetzoldt.github.io/elements-de)
-   Übungen:
    [tpetzoldt.github.io/element-labs](https://tpetzoldt.github.io/element-labs)
-   Daten:
    [tpetzoldt.github.io/datasets](https://tpetzoldt.github.io/datasets)
...
3.  **Numerische Analysis:** Implementierung von statistischen Methoden auf Computern, insbesondere bei großen oder komplexen Datensätzen.
...
::: {.column width="58%"}
1.  "lingua franca of computational statistics".
...
3.  Weniger kompliziert als man denkt:
