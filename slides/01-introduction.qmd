...
# Vorwort {data-background-color="#006ab2"}
...
-   Folien, Tutorien:
    [tpetzoldt.github.io/elements](https://tpetzoldt.github.io/elements)
-   Übungen:
...
Täglicher durchschnittlicher Abfluss der Elbe, Pegel Dresden, Fluss km
55,6
...
$>$ 70.000 Messungen. Wie können wir das analysieren und was bedeutet
das?

Datenquelle: [Bundesanstalt für
Gewässerkunde](https://raw.githubusercontent.com/tpetzoldt/datasets/main/data/elbe_info.txt)

## Grafik der letzten 20 Jahre
...
-   Wie hoch ist der durchschnittliche Abfluss? → Mittelwerte
...
-   In der rechten Version reichen die Whisker bis zum extremsten
    Datenpunkt, der nicht mehr als das 1,5-fache des
    Interquartilabstandes der Box beträgt.

## Drei Wege mit Statistiken zu arbeiten
...
-   Unterscheidung von Effekten und zufälligen Schwankungen
...
**Wie wahrscheinlich ist es, dass unsere Hypothese wahr ist?**
...
-   (Wie) hängt die beobachtete Algenbiomasse vom Phosphor ab?<br>

## Statistische Modellierung

<br>

**Anpassung eines statistischen Modells an die Daten**

-   Wahl einer geeigneten Modellierungsstrategie
-   Entwurf statistischer Modelle
-   Messung der Effektgröße
-   Auswahl des optimalen Modells aus verschiedenen Modellkandidaten

**Beispiele**

-   Anpassung einer Verteilung an die jährlichen Abflussdaten, um das
    100-jährige Hochwasser zu schätzen.
-   Passen Sie ein ANOVA-Modell an experimentelle Daten an, um
    festzustellen, welcher Faktor das Ergebnis am meisten beeinflusst.
-   Anpassen eines multiplen linearen Modells an Klimadaten, um
    festzustellen, wie sehr sich die Klimatrends zwischen den einzelnen
...
-   Hat der Gewichtsunterschied etwas mit dem Geschlecht der Babys zu tun oder handelt es sich um eine reine Zufallsschwankung?
...
-   Abhängigkeit der Chlorophyllkonzentration in Seen von Phosphor, ein regionaler Datensatz von Koschel und Scheffler (1985) (links) und von Vollenweider und Kerekes (1980) (rechts).
-   Welche der beiden Abbildungen hat eine größere Vorhersagekraft? Warum?

::: aside
Der Parameter $r$ ist der Korrelationskoeffizient nach Pearson.
:::

# Wie kann dies in der Praxis durchgeführt werden? {data-background-color="#006ab2"}
...
-   **Versuche das wide-Format zu vermeiden.** Es kann zu Ungereimtheiten und Komplikationen bei der Analyse führen.
-   **Bereinige die Daten vor der Analyse** und konvertiere das wide-Format in das long-Format.
...
2.  **Kalkül:** Optimierungsprobleme, Ableitung statistischer Formeln, Verständnis des Verhaltens von Funktionen.
...
[$\rightarrow$ Die ordnungsgemäße Verwendung fertiger Softwarepakete erfordert ein grundlegendes Verständnis.]{.red}
...
-   RStudio zur Verbesserung der Benutzerfreundlichkeit von R
...
::: {.column width="58%"}
1.  Statistiker bezeichnen es als „lingua franca“ in der computergestützten Statistik.
    - Äußerst leistungsfähig
    - Kein anderes System verfügt über so viele Statistiken
    - Wird in der statistischen Forschung verwendet
2.  Frei (OpenSource)
    - Frei zu benutzen
    - Frei zu modifizieren
    - Frei, etwas beizutragen
3.  Weniger kompliziert als es auf den ersten Blick scheint:
    - Ja, es braucht Kommandozeilenprogrammierung
    - aber: schon eine einzige Zeile kann viel bewirken
    - große Anzahl von Büchern und Online-Skripten
:::
...
Im Gegensatz zu anderen Systemen ist Copy & Paste erlaubt! - einfach zitieren.

## Bücher

**Statistik**

-   Gut lesbare Einführungen
    -   Dalgaard, P., 2008: Introductory Statistics with **R**.
        Springer, New York, 2nd edition. (fulltext of the 1st edition
        [freely
        available](https://link.springer.com/book/10.1007/b97671))
    -   Verzani, J. (2019). Using R for introductory statistics. CRC
        press.
-   Eine sehr gut verständliche Einführung in viele Bereiche der Statistik, insbesondere in die Regressions- und Zeitreihenanalyse:
...
-   Eine Einführung in die Datenwissenschaft unter Verwendung des modernen „Tidyverse“-Ansatzes:
