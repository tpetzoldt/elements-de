...
## Homogenität der Varianz bei > 2 Stichproben
...
## Bestimmung der Power von statistischen Tests
...
[$\Rightarrow$ Man braucht entweder einen großen Stichprobenumfang oder einen starken Effekt.]{.darkred}
...
* Ist der Variationskoeffizient $cv=s/\bar{x}$ < 0.33 (oder zumindest < 0.5)?<br>
[Wenn die Daten zu nahe an der Null liegen: rechtsschiefe Verteilung wahrscheinlich.]{.smallfont}
...
* Formale Tests, wie Shapiro-Wilk, $\chi^2$- (Chi-Quadrat-) oder Kolmogorov-Smirnov, werden zur Überprüfung der Normalitätsannahme für t-Tests und ANOVA [nicht mehr empfohlen]{.red}.
* für andere Testprobleme durchaus nützlich.
...
* Einige moderne Methoden (z. B. verallgemeinerte lineare Modelle, GLM) können bestimmte 
...
[$\rightarrow$ besser: ein GLM der Familien Poisson oder Quasi-Poisson in Betracht ziehen]{.blue}
...
[$\rightarrow$ besser: ein GLM mit Binomialverteilung in Betracht ziehen]{.blue}
<!-----------------------------------------------------------------------------/ -->
