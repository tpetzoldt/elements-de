...
**Unvoreingenommenheit:** die Schätzung konvergiert gegen den wahren Wert
  mit zunehmendem $n$
* **Effizienz** ein relativ kleines $n$ ist ausreichend für eine gute
  Schätzung
* **Robustheit** die Schätzung wird durch Ausreißer oder bestimmte Verletzungen statistischer Annahmen kaum beeinflusst

Je nach Fragestellung gibt es verschiedene Klassen von Parametern
existieren, insbesondere Maße der Lage (z.B. Mittelwert, Median), der Variation
...
vermeidet große Zahlen, die dem Computer Probleme bereiten.
:::
...
Du fährst mit 50km/h zur Uni und mit 100km/h wieder nach Hause.<br> 
...
* auch „abgeschnittener Mittelwert“ genannt
...
* Median und getrimmter Mittelwert werden weniger von Ausreißern und Schiefen beeinflusst $\rightarrow$ [robuster]{.blue}
...
* Erweiterung auf kontinuierliche Skalen: Bündelung oder Dichteschätzung

Erste Vermutung: Mitte der häufigsten Klasse.
...
:::{.gray}
In der Praxis wird $s^2$ oft damit berechnet:
...
* Nützlich für den Vergleich von Variationen verschiedener Variablen, unabhängig von ihrer Maßeinheit
...
wobei $\Phi^{-1}$ die Quantilsfunktion der Normalverteilung ist.
...
Der Median der absoluten Differenzen zwischen Median und Werten.

$$
  MAD = \text{median}(|\text{median} - x_i|)
$$

* in einigen Communities häufig verwendet, in unserem Bereich selten verwendet
...
* spielt eine zentrale Rolle bei der Berechnung von Konfidenzintervallen und statistischen Tests
