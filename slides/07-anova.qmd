...
<div class="hbox">
![](../img/ansaetze2.jpg)
Dünger -- D. offene Flasche -- D. + Zucker -- D. + CaCO3 -- Basalmedium -- A. dest -- Leitungswasser
</div>
...
* Die Kruztabellenstruktur ist kompakt und übersichtlich, jedoch nicht ideal für die Datenanalyse.
* $\Rightarrow$ Konvertierung sie in das Langformat
...
* sieht „unpraktisch“ aus, ist aber besser für die Datenanalyse
...
... können direkt in den Code eingegeben werden. Eine csv-Datei im Langformat ist ebenfalls möglich.
...
* Die Varianzentrennung erfolgt über ein [lineares Modell]{.blue}.
...
<br>
Zurück zu den Daten über das Algenwachstum.
...
* Wir können die Koeffizienten mit `summary(m)` ausgeben.
...
3. **Dokumentiere die Diagnostik** – grafisch und kritisch (QQ-Plot, Residuals vs. Fitted).
...
Der `oneway.test` berücksichtigt ungleiche Varianzen durch gewichtete Mittelwerte und eine angepasste F-Statistik.
